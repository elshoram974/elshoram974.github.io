...
| `google_api_data_disclosure/index.html` | `/google_api_data_disclosure/` | MRE CashBook Google API data disclosure: the `drive.appdata` scope and the Limited Use commitment. |
...
`mre_cashbook_home.html` and `google_api_data_disclosure.html` remain at the root as `noindex`
